...
export const GUI_TRANSLATION_OVERRIDES: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "settings.navSystemIntegration": "系统集成",
    "settings.groupOther": "其他",
    "settings.systemIntegrationTitle": "资源管理器集成",
    "settings.contextMenuTitle": "在文件夹右键菜单中显示 LiveAgent",
    "settings.contextMenuDesc":
      "在资源管理器的文件夹上、文件夹内空白处、或「此电脑」里的驱动器上右键时，显示「在 LiveAgent 中打开」，把该文件夹作为工作区打开。Windows 11 上该项位于「显示更多选项」子菜单中。",
    "settings.contextMenuUnsupported": "资源管理器右键菜单集成仅支持 Windows。",
    "settings.contextMenuToggleFailed": "设置右键菜单失败。",
    ...
    "tray.restart": "重启 LiveAgent",
    "tray.restartWithRuns": "重启 LiveAgent（{count} 个对话运行中）",
    "tray.restartToUpdate": "重启以完成更新",
  ...
  "en-US": {
    ...
    "settings.navSystemIntegration": "System integration",
    "settings.groupOther": "Other",
    "settings.systemIntegrationTitle": "File Explorer integration",
    "settings.contextMenuTitle": "Show LiveAgent in the folder context menu",
    "settings.contextMenuDesc":
      'Right-clicking a folder, the empty area inside one, or a drive under "This PC" shows "Open in LiveAgent" and opens that folder as a workspace. On Windows 11 the entry lives under "Show more options".',
    "settings.contextMenuUnsupported": "File Explorer context menu integration is Windows only.",
    "settings.contextMenuToggleFailed": "Failed to update the context menu setting.",
    ...
    "tray.restart": "Restart LiveAgent",
    "tray.restartWithRuns": "Restart LiveAgent ({count} chats running)",
    "tray.restartToUpdate": "Restart to Finish Update",
