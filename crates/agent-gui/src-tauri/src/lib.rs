...
macro_rules! app_invoke_handler {
    () => {
        tauri::generate_handler![
            ...
            commands::system::system_save_theme_background_image,
            commands::system::system_read_theme_background_image,
            commands::system::system_clear_theme_background_image,
