export const ZH_CN_COMMON_TRANSLATIONS = {
  ...
  "chat.workspaceCreateDescription":
    "打开已有文件夹、从 SSH 隧道选择远程文件夹，或从远程 Git 仓库创建新的工作空间。",
  "chat.workspaceOpenFolder": "打开本地文件夹",
  "chat.workspaceOpenFolderDescription": "将已有文件夹添加为工作空间。",
  "chat.workspaceRemoteFolder": "从 SSH 隧道选择远程文件夹",
  "chat.workspaceRemoteFolderDescription":
    "浏览已建立的 SSH 隧道，选远程服务器上的文件夹作为工作空间根目录。",
  "chat.workspaceRemotePickerTitle": "选择远程文件夹",
  "chat.workspaceRemotePickerDescription":
    "通过已连接的 SSH 隧道浏览远程目录，选定一个文件夹作为工作空间根目录。",
  "chat.workspaceRemoteHostsLoading": "正在读取 SSH 隧道…",
  "chat.workspaceRemoteTunnel": "SSH 隧道",
  "chat.workspaceRemoteTunnelPlaceholder": "选择一条 SSH 隧道",
  "chat.workspaceRemoteConnected": "已连接",
  "chat.workspaceRemoteConnect": "连接",
  "chat.workspaceRemoteConnecting": "正在连接…",
  "chat.workspaceRemoteConnectRequiredTitle": "这条隧道尚未连接",
  "chat.workspaceRemoteConnectRequiredDescription": "先建立 SSH 连接，才能浏览该主机上的目录。",
  "chat.workspaceRemotePromptHostKeyTitle": "确认主机密钥",
  "chat.workspaceRemotePromptAuthTitle": "需要 SSH 认证",
  "chat.workspaceRemotePromptTrust": "信任并继续",
  "chat.workspaceRemotePromptSubmit": "确认",
  "chat.workspaceRemotePromptCancel": "取消",
  "chat.workspaceRemotePathLabel": "远程路径",
  "chat.workspaceRemotePathPlaceholder": "/home/user/project",
  "chat.workspaceRemoteGo": "前往",
  "chat.workspaceRemoteUp": "上一级",
  "chat.workspaceRemoteRefresh": "刷新",
  "chat.workspaceRemoteLoading": "正在读取远程目录…",
  "chat.workspaceRemoteEmptyDir": "此目录下没有子文件夹。",
  "chat.workspaceRemoteSelect": "使用此文件夹",
  "chat.workspaceRemoteSelectedPath": "将以此目录作为工作空间根目录：",
  "chat.workspaceRemoteRetry": "重试",
  "chat.workspaceRemoteNoHostsTitle": "还没有添加 SSH 隧道",
  "chat.workspaceRemoteNoHostsDescription":
    "先到「SSH 隧道」面板添加一条主机，再回来选择远程文件夹。",
  "chat.workspaceRemoteOpenTunnelPanel": "打开 SSH 隧道面板",
  "chat.workspaceRemoteErrorNoSession": "没有可用的 SSH 隧道，请先建立连接。",
  "chat.workspaceRemoteErrorSessionMissing": "该 SSH 会话已不存在，请重新建立隧道。",
  "chat.workspaceRemoteErrorDisconnected": "SSH 连接已断开，请重连隧道后重试。",
  "chat.workspaceRemoteErrorSftpDisabled": "该会话未开启 SFTP，无法浏览远程目录。",
  "chat.workspaceRemoteErrorHostMissing": "SSH 主机配置不存在，可能已被删除。",
  "chat.workspaceRemoteErrorPermissionDenied": "没有权限访问该目录。",
  "chat.workspaceRemoteErrorNotFound": "远程目录不存在。",
  "chat.workspaceRemoteErrorNotDirectory": "所选路径不是文件夹。",
  "chat.workspaceRemoteErrorUnknown": "读取远程目录失败。",
  "chat.workspaceRemoteFileTreeUnsupported":
    "远程工作空间无法在本地文件树中打开，请使用 SSH 隧道面板的 SFTP 浏览。",
  "chat.workspaceRemoteRevealUnsupported": "远程工作空间无法在本地文件管理器中打开。",
  "chat.workspaceRemoteMountUnsupported":
    "远程工作空间无法挂载本地文件夹作为附属目录，请直接在远端目录中操作。",
  "chat.workspaceOr": "或",
  ...
  "chat.workspaceSettingsRemoteDirectoryHint":
    "该工作空间根目录位于远程服务器，通过 SSH 隧道访问；本地附属目录不适用。",
  ...
  "projectTools.remoteWorkspaceTitle": "远程工作空间",
  "projectTools.newRemoteWorkspace": "打开远程工作空间",
  "projectTools.remoteWorkspaceDescription": "在当前远程文件夹中同时使用 Bash 与 SFTP",
  "projectTools.closeRemoteWorkspace": "关闭远程工作空间",
  "projectTools.remoteWorkspaceNeedsRemote":
    "仅远程工作空间可用：先在侧栏切到 SSH 隧道里的远程文件夹。",
  "projectTools.remoteWorkspaceReconnect": "重新连接",
  "projectTools.remoteWorkspaceResize": "调整终端与 SFTP 的高度",
  "projectTools.remoteWorkspaceHostMissing":
    "该主机已从【SSH 隧道】设置里删除，请重新添加后再连接。",
  "projectTools.remoteWorkspaceSessionGone": "这条 SSH 会话已失效，请重新连接。",
  ...
  "projectTools.fileTree.deleteMultiConfirm": "删除选中的 {count} 项？",
  "projectTools.fileTree.deleteConfirmDescription": "此路径会从磁盘删除，此操作无法撤销。",
  "projectTools.fileTree.deletePartialFailed": "已删除 {done} 项，{failed} 项失败：{message}",
  "projectTools.fileTree.deleteConfirmClose": "关闭删除确认",
  "projectTools.fileTree.deleteFailed": "删除失败",
  "projectTools.fileTree.selectedCount": "已选择 {count} 项",
  ...
  "workspaceEditor.context.closeTabsMenu": "关闭标签",
  "workspaceEditor.context.closeTabsLeft": "关闭左侧标签",
  "workspaceEditor.context.closeTabsOthers": "关闭其它标签",
  "workspaceEditor.context.closeTabsAll": "关闭所有标签",
  ...
  "workspaceEditor.closeTabsDirtyTitle": "关闭这些文件前保存修改？",
  "workspaceEditor.closeTabsDirtyDescription":
    "这些文件中有未保存修改。你可以保存全部、放弃修改，或返回继续编辑。",
