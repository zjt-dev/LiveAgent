...
function utf8Bytes(text: string): Uint8Array {
  ...
  // Supported browsers, Tauri WebView and Node expose TextEncoder. This fallback
  // keeps the pure helper usable in isolated source loaders too.
  const bytes: number[] = [];
...
/** Synchronous, dependency-free SHA-256 for trajectory content addressing. */
